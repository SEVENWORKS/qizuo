window.$global = {
  ...
  error: -1,
  /** url prefix */
  url_prefix: "http://47.101.136.113:9300/port",
  /** 主menu菜单 */
  sysMenu:[
    {name:'用户',icon:'el-icon-user',url:'',child:[{name:'用户管理',icon:'',url:'/system/system_user',child:[]},{name:'角色管理',icon:'',url:'/system/system_role',child:[]},{name:'菜单管理',icon:'',url:'/system/system_menu',child:[]},{name:'消息管理',icon:'',url:'/system/system_msg',child:[]}]},
