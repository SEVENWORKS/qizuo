<template>
  <div>
    <!-- 内容区域 -->
    <form class="block-area" id="dataContainer" style="width: 75%;"></form>
            ...
            function (data) {
              backResult(data, function (data) {
                if (isNotBlank(data)) {
                  ...
                  //多选
                  if ($(".select")[0]) {
                    var dataScopeCdsArr = isNotBlank(data.dataScopeCds)
                      ? data.dataScopeCds.split(",")
                      : null;
