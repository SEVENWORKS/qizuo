...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: "index",
        component: () => import("../views/base/documentation/index"),
        name: "Documentation",
...
export const asyncRoutes = [
...

  {
    ...
    children: [
      {
        path: "create",
        component: () => import("../views/base/example/create"),
        name: "CreateArticle",
        meta: { title: "Create Article", icon: "edit" },
      },
      {
        path: "edit/:id(\\d+)",
        component: () => import("../views/base/example/edit"),
        name: "EditArticle",
        meta: {
          title: "Edit Article",
          noCache: true,
      ...
      {
        path: "list",
        component: () => import("../views/base/example/list"),
        name: "ArticleList",
