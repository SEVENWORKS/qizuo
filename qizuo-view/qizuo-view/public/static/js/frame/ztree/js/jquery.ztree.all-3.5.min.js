  ...
  var G,
    ...
    h = {
      ...
      getNodesByFilter: function (b, a, c, d, f) {
        if (!a) return d ? null : [];
        for (
          var g = b.data.key.children, e = d ? null : [], i = 0, n = a.length;
          i < n;
          i++
        ) {
    ...
    i = {
      ...
      appendNodes: function (b, a, c, d, f, g) {
        ...
        for (
          ...
          o[j] &&
            o[j].length > 0 &&
            (t = i.appendNodes(b, a + 1, o[j], o, f, g && o.open));
          g &&
...
(function (m) {
  ...
  m.extend(!0, m.fn.zTree._z, {
    ...
    view: {
      checkNodeRelation: function (b, a) {
        ...
        if (b.check.chkStyle == c.STYLE) {
            ...
            if (b.check.radioType == c.TYPE_ALL) {
              ...
              for (d = 0, h = g[i].length; d < h; d++)
                (c = g[i][d]),
                  c[l] &&
                    c != a &&
                    ((c[l] = !1), e.setChkClass(b, n(c, j.id.CHECK, b), c));
            }
          ...
          a[l] &&
            (!a[i] ||
              a[i].length == 0 ||
              b.check.chkboxType.Y.indexOf("s") > -1) &&
            e.setSonNodeCheckBox(b, a, !0),
            !a[l] &&
              (!a[i] ||
                a[i].length == 0 ||
                b.check.chkboxType.N.indexOf("s") > -1) &&
              e.setSonNodeCheckBox(b, a, !1),
            a[l] &&
              b.check.chkboxType.Y.indexOf("p") > -1 &&
              e.setParentNodeCheckBox(b, a, !0),
            !a[l] &&
      ...
      repairParentChkClassWithSelf: function (b, a) {
        if (a) {
          var c = b.data.key.children;
          a[c] && a[c].length > 0
            ? e.repairParentChkClass(b, a[c][0])
            : e.repairParentChkClass(b, a);
        }
      },
      ...
      setParentNodeCheckBox: function (b, a, c, d) {
        ...
        a.nocheck !== !0 &&
          ...
          b.check.autoCheckTrigger &&
            a != d &&
            b.treeObj.trigger(j.event.CHECK, [null, b.treeId, a]));
        if (a.parentTId) {
          l = !0;
          if (!c)
    ...
    data: {
      getRadioCheckedList: function (b) {
        for (
          var a = f.getRoot(b).radioCheckedList, c = 0, d = a.length;
          c < d;
          c++
        )
        ...
        for (
          var h = b.data.key.children,
            ...
            e =
              c &&
              b.check.chkStyle == j.radio.STYLE &&
              b.check.radioType == j.radio.TYPE_ALL,
            d = !d ? [] : d,
            g = 0,
            k = a.length;
          g < k;
  ...
  f.addInitNode(function (b, a, c, d) {
    if (c) {
      ...
      c.chkDisabled =
        !!c.chkDisabled || (b.check.chkDisabledInherit && d && !!d.chkDisabled);
    ...
    a.checkNode = function (a, c, i, f) {
      ...
      if (
        ...
        (a[g] !== c || i) &&
          !(
            f &&
            k.apply(this.setting.callback.beforeCheck, [b.treeId, a], !0) == !1
          ) &&
        ...
        (a[g] = c),
          (c = n(a, j.id.CHECK, b)),
          (i || b.check.chkStyle === j.radio.STYLE) &&
...
(function (w) {
        ...
        function c(b) {
          ...
          if (B.dragFlag == 0) {
            ...
            for (a = 0, c = m.length; a < c; a++) {
              ...
              o = m[a];
              o.isParent && o.open
                ? (e.expandCollapseNode(f, o, !o.open),
                  (B.dragNodeShowBefore[o.tId] = !0))
            ...
            if (m.length > 1) {
              ...
              for (a = 0, c = j.length; a < c; a++)
                if (
                  (B.dragNodeShowBefore[j[a].tId] !== void 0 &&
                    (o && k > -1 && k + 1 !== a && (o = !1),
                    i.push(j[a]),
                    (k = a)),
                  m.length === i.length)
            ...
            for (a = 0, c = m.length; a < c; a++)
              if (
                ((o = m[a]),
                (o.editNameFlag = !1),
                e.selectNode(f, o, a > 0),
                e.removeTreeDom(f, o),
                (k = p("<li id='" + o.tId + "_tmp'></li>", f)),
                k.append(p(o, d.id.A, f).clone()),
                k.css("padding", "0"),
                k
                  .children("#" + o.tId + d.id.A)
                  .removeClass(d.node.CURSELECTED),
                C.append(k),
                a == f.edit.drag.maxShowNodeNum - 1)
              ) {
          ...
          if (B.dragFlag == 1) {
            ...
            b.clientX + F.scrollLeft() + 2 >
              ...
              ? ((o = w("#" + u + d.id.A, s)),
                (b.target = o.length > 0 ? o.get(0) : b.target))
              : s &&
            ...
            for (var D in o)
              if (
                ...
                o[D].edit.enable &&
                o[D].treeId != f.treeId &&
                (b.target.id == o[D].treeId ||
                  w(b.target).parents("#" + o[D].treeId).length > 0)
              )
                (J = !0), (h = o[D]);
            D = F.scrollTop();
            k = F.scrollLeft();
            ...
            var j = q < f.edit.drag.borderMax && q > f.edit.drag.borderMin,
              ...
              q =
                c > f.edit.drag.borderMin &&
                q > f.edit.drag.borderMin &&
                r > f.edit.drag.borderMin &&
                x > f.edit.drag.borderMin,
            ...
            if (s && s.attr("id") != h.treeId) {
              ...
              c =
                (b.ctrlKey && f.edit.drag.isMove && f.edit.drag.isCopy) ||
              ...
              o =
                (c || !i) &&
                g.apply(h.edit.drag.prev, [h.treeId, m, y], !!h.edit.drag.prev);
              a =
                (c || !a) &&
                g.apply(h.edit.drag.next, [h.treeId, m, y], !!h.edit.drag.next);
              G =
                (c || !k) &&
              ...
              if (!o && !a && !G) {
                ...
                i = y.isLastNode
                  ? null
                  : w("#" + y.getNextNode().tId + d.id.A, s.next());
                j = c.offset().top;
                k = c.offset().left;
                ...
                (K == 1 || (b <= K && b >= -0.2)) && o
                  ...
                  ? ((a = 1 - A.width()),
                    (i =
                      i == null || (y.isParent && y.open)
                        ? j + c.height() - A.height() / 2
                        : i.offset().top - A.height() / 2),
                    (v = d.move.TYPE_NEXT))
                ...
                if (
                  ...
                  (window.zTreeMoveTimer = setTimeout(function () {
                    v == d.move.TYPE_INNER &&
                      ...
                      g.apply(h.callback.beforeDragOpen, [h.treeId, y], !0) &&
                      (e.switchNode(h, y),
                      h.edit.drag.autoExpandTrigger &&
                        h.treeObj.trigger(d.event.EXPAND, [h.treeId, y]));
        ...
        function l(b) {
          ...
          if (B.dragFlag != 0) {
            ...
            for (a = 0, i = m.length; a < i; a++)
              (j = m[a]),
                j.isParent &&
                  ...
                  !j.open &&
                  (e.expandCollapseNode(f, j, !j.open),
            ...
            if (s) {
              ...
              if (
                g.apply(f.callback.beforeDrop, [h.treeId, m, r, v, q], !0) == !1
              )
                e.selectNodes(x, m);
              else {
                var z = q ? g.clone(m) : m;
                a = function () {
                  if (J) {
                    ...
                    if (v == d.move.TYPE_INNER) e.addNodes(h, r, z);
                      ...
                      (e.addNodes(h, r.getParentNode(), z),
                      v == d.move.TYPE_PREV)
                    )
                    ...
                    (q && e.addNodes(h, r.getParentNode(), z),
                    v != d.move.TYPE_NEXT)
                  )
                    for (a = 0, c = z.length; a < c; a++)
                      e.moveNode(h, r, z[a], v, !1);
                ...
                v == d.move.TYPE_INNER && g.canAsync(h, r)
                  ? e.asyncNode(h, r, !1, a)
                  : a();
              }
            } else
  ...
  w.extend(!0, w.fn.zTree._z, {
    ...
    view: {
      addEditBtn: function (b, a) {
        if (
          !(a.editNameFlag || p(a, d.id.EDIT, b).length > 0) &&
      ...
      addRemoveBtn: function (b, a) {
        if (
          !(a.editNameFlag || p(a, d.id.REMOVE, b).length > 0) &&
      ...
      editNode: function (b, a) {
        var c = n.getRoot(b);
        e.editNodeBlur = !1;
        if (n.isSelectedNode(b, a) && c.curEditNode == a && a.editNameFlag)
          setTimeout(function () {
          ...
          k.bind("blur", function () {
            ...
            .bind("keydown", function (a) {
              a.keyCode == "13"
                ? ((e.editNodeBlur = !0), e.cancelCurEditNode(b))
                : a.keyCode == "27" && e.cancelCurEditNode(b, null, !0);
            })
            .bind("click", function () {
              return !1;
            })
      ...
      moveNode: function (b, a, c, l, k, i) {
        ...
        if (
          ...
          t
            ? (q = t = b.treeObj)
            : (!i && l == d.move.TYPE_INNER
                ? e.expandCollapseNode(b, a, !0, !1)
                : i || e.expandCollapseNode(b, a.getParentNode(), !0, !1),
              (t = p(a, b)),
              (q = p(a, d.id.UL, b)),
              t.get(0) &&
                !q.get(0) &&
                ((q = []), e.makeUlHtml(b, a, q, ""), t.append(q.join(""))),
              (q = p(a, d.id.UL, b)));
          var r = p(c, b);
          r.get(0)
            ? t.get(0) || r.remove()
            : (r = e.appendNodes(b, c.level, [c], null, !1, !0).join(""));
          q.get(0) && l == d.move.TYPE_INNER
            ? q.append(r)
            : t.get(0) && l == d.move.TYPE_PREV
            ? t.before(r)
            : t.get(0) && l == d.move.TYPE_NEXT && t.after(r);
          var m = -1,
            w = 0,
            x = null,
            t = null,
          ...
          !b.data.keep.parent && g[f].length < 1
            ? ((g.isParent = !1),
              ...
              (l = p(g, d.id.SWITCH, b)),
              (f = p(g, d.id.ICON, b)),
              e.replaceSwitchClass(g, l, d.folder.DOCU),
              e.replaceIcoClass(g, f, d.folder.DOCU),
              a.css("display", "none"))
          ...
          b.check &&
            b.check.enable &&
            e.repairChkClass &&
            (e.repairChkClass(b, g),
            e.repairParentChkClassWithSelf(b, g),
            g != c.parent && e.repairParentChkClassWithSelf(b, c));
  ...
  n.addInitProxy(function (b) {
    ...
    if (g.eqs(b.type, "mouseover")) {
      if (
        (p = g.getMDom(c, a, [{ tagName: "a", attrName: "treeNode" + d.id.A }]))
      )
        (k = g.getNodeMainDom(p).id), (j = "hoverOverNode");
    } else if (g.eqs(b.type, "mouseout"))
      (p = g.getMDom(c, e, [{ tagName: "a", attrName: "treeNode" + d.id.A }])),
  ...
  n.addZTreeTools(function (b, a) {
    ...
    a.copyNode = function (a, l, k, i) {
      ...
      k == d.move.TYPE_INNER
        ? ((l = function () {
          ...
          g.canAsync(b, a) ? e.asyncNode(b, a, i, l) : l())
        : (e.addNodes(b, a.parentNode, [j], i), e.moveNode(b, a, j, k, !1, i));
      return j;
    };
    ...
    a.moveNode = function (a, l, k, i) {
      ...
      if (a && !a.isParent && b.data.keep.leaf && k === d.move.TYPE_INNER)
        ...
        a &&
        ((l.parentTId == a.tId && k == d.move.TYPE_INNER) ||
          p(l, b).find("#" + a.tId).length > 0)
      )
        return null;
      else a || (a = null);
      g.canAsync(b, a) && k === d.move.TYPE_INNER
        ? e.asyncNode(b, a, i, j)
        : j();
      return l;
    };
