...
public class OAuth2FeignAutoConfiguration {
	 ...
	 */
	@Autowired
	public OAuth2FeignAutoConfiguration(Oauth2ClientPropertiesY oauth2ClientProperties) {
	 ...
	 */
	@Bean
	public RequestInterceptor oauth2FeignRequestInterceptor(@Qualifier("oAuth2RestTemplate")OAuth2RestTemplate oAuth2RestTemplate) {
