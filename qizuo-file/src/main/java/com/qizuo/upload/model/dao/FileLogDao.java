package com.qizuo.upload.model.dao;
...
@Mapper
@Repository
public interface FileLogDao extends BaseDao<FileLogPoJo> {
  /**
   * @author: fangl
   * @description: 修改文件日志状态
   * @date: 17:44 2019/1/9
   */
  boolean uLogResult(FileLogPoJo fileLogPoJo);
   ...
   * @date: 17:44 2019/1/9
   */
  boolean iAbatchInsert(List<FileLogPoJo> fileLogPoJos);
}
