...
import com.qizuo.provider.model.po.SpiderPoJo;
import com.qizuo.provider.service.dao.SpiderDao;
...
public class SpiderService extends BaseService<SpiderDao, SpiderPoJo> {
}
