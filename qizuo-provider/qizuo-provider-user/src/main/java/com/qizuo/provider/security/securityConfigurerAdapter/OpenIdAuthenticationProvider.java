...
package com.qizuo.provider.security.securityConfigurerAdapter;
...
/**
 * 自定义身份认证 认证是由 AuthenticationManager 来管理的，但是真正进行认证的是 AuthenticationManager 中定义的 AuthenticationProvider。AuthenticationManager 中可以定义有多个 AuthenticationProvider.
 *
